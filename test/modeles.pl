...
print "### CATEGORIES ###\n";
my $cat0 = Categorie->new("", 'Informatique');
my $cat1 = Categorie->new("", 'Electromenager');
my $cat2 = Categorie->new("", 'Hi-Fi');
my $cat3 = Categorie->new("", 'Domotique');
my $cat4 = Categorie->new("", 'Auto');
my $cat5 = Categorie->new("", 'Jardin');
my $cat6 = Categorie->new("", 'Destockage');
